...
/**
 * Defines PaypalPayments entity.
 *
 * @ingroup paypal_payments
 *
 * @ContentEntityType(
 *   id = "paypal_payments",
 *   label = @Translation("PaypalPayments"),
...
class PaypalPayments extends ContentEntityBase implements ContentEntityInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['uid'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setDescription(t('The user.uid that made the payment'));
    ...
    $fields['nid'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setSetting('handler', 'default')
      ->setDescription(t('The node the payment is attached to .'));
